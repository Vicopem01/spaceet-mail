...
const Messages = () => {
  ...
  return (
    <>
      <Header abbreviation={"JK"} title={"JOHN KENT"} />
      <div className={classes.container}>
        <div className={classes.content}>
          <form>
            ...
            >
              <option value="hello@spaceet.com">HELLO@SPACEET.COM</option>
              <option value="support@spaceet.com">SUPPORT@SPACEET.COM</option>
              <option value="noreply@spaceet.com">NOREPLY@SPACEET.COM</option>
            </select>
            <br />
            <br />
